...
async function generatePDFEstudiosPrevios() {
    ...
    const objetoTitulo = 'PRESTACION DE SERVICIOS DE APOYO A LA GESTION COMO CELADOR EN LAS DIFERENTES DEPENDENCIAS DE LA ALCALDIA MUNICIPAL DE EL BANCO, MAGDALENA.';
    ...
    const alcanceTexto = 'El alcance del objeto: 1. Cumplir con el objeto contractual y las actividades que de él se derivan, entre ellas: a). Seguridad. b). Ejercer la vigilancia y protección de bienes muebles e inmuebles, así como protección de las personas que se encuentren en las instalaciones de la alcaldía. c). Efectuar los controles de identidad en el acceso o en el interior de las instalaciones de la alcaldía. d). Evitar la comisión de actos delictivos o infracciones en relación con el objeto de su protección. e). Poner en conocimiento y disposición de los miembros de las fuerzas y cuerpos de seguridad a los delincuentes, en relación con el objeto de su protección. También los instrumentos, efectos y pruebas de los delitos. f). Realización de rondas de seguridad. 2. Prestar con eficiencia, calidad y eficacia los servicios contratados. 3. Acatar las instrucciones que se impartan para el cabal cumplimiento del presente contrato. 4. Guardar la debida y completa reserva y confidencialidad sobre la información y los documentos de que pueda tener conocimiento o los que tenga acceso en virtud del contrato. 5. Cumplir las obligaciones contractuales, teniendo en cuenta lo señalado en la minuta que para tal efecto suscribirá. 6. Presentar los documentos necesarios para la suscripción del respectivo contrato. 7. Presentar informes sobre las actividades desarrolladas, para efectos de poder certificar el cumplimiento del objeto del contrato y de la actividad. 8. Prestar los servicios contratados de manera eficaz y oportuna, así como atender los requerimientos que le sean efectuados por el supervisor del contrato en desarrollo del objeto contractual. 9. Las demás propias del objeto contratado que sean necesarios para dar cumplimiento.';
