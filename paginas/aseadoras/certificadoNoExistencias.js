...
async function generatePDFCertificadoNoExistenciaAseadora() {
    ...
    const textoContratoLargoCertificadoPrimario = `Que no existe, es insuficiente o no está en capacidad el personal de planta o de nómina de la Alcaldía municipal de El Banco, Magdalena, para la contratación cuyo objeto es la; "PRESTACION DE SERVICIOS PROFESIONALES Y APOYO A LA GESTION COMO ASEADORA EN LAS DIFERENTES INSTALACIONES DE LA ALCALDIA MUNICIPAL DE EL BANCO, MAGDALENA". Así mismo que dentro del plan de anual de adquisiciones del año 2025, se encuentra incluida la contratación del personal para la prestación del servicio en mención.`;
